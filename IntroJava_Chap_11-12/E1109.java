...
public class E1109 {
    public static void main(String[] args){
        int[][] m = createMatrix();
        printMatrix(m);
        System.out.println("The largest row index: " + largestRow(m).toString());
        System.out.println("The largest column index: " + largestColumn(m).toString());
    }
    ...
    public static ArrayList largestRow(int[][]matrix) {
    ...
    public static ArrayList largestColumn(int[][]matrix) {
        ArrayList<Integer> list = new ArrayList<>();
        int max = -1;
