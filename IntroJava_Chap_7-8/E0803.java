/* (Sort students on grades) Rewrite Listing 8.2, GradeExam.java, to display students
...
public class E0803 {
    public static void main(String[] args) {
        ...
        int[][] correctAnswer = new int[8][key.length];
    ...
    public static void printScores(int[][] correctAnswer) {
        ...
        // print in pair
        for (int i = 0; i < correctAnswer.length; i++ ) {
            System.out.println("Student " + correctAnswer[i][0] + "'s correct answer count is " + correctAnswer[i][1]);
        }
    }
}
