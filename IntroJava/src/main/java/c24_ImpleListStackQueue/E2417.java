...
public class E2417 {
    public static void main(String[] args) {
        ...
        Patient[] patients = {new Patient("John", 2), new Patient("Jim", 1),
                            new Patient("Tim", 5), new Patient("Cindy", 7)};

        PrioritySortedArrayList<Patient> patientQueue = new PrioritySortedArrayList<>();
        ...
        PrioritySortedArrayList<Patient> patientQueue2 = new PrioritySortedArrayList<>(patients);
        while (patientQueue2.getSize() > 0) {
            System.out.println(patientQueue2.dequeue());
        }
    }
}
