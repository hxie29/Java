package c08_MultidimensionArrays;/* (Compute the weekly hours for each employee) Suppose the weekly hours
...
public class E0804 {
    ...
    public static void printHours(int[][] weeklyHours) {
        ...
        for (int[] weeklyHour : weeklyHours) {
            System.out.println("Employee " + weeklyHour[0] + "'s weekly working hours is " + weeklyHour[1]);
        }
    }
}
